...
def is_known():
    ...
    data.to_csv("/Users/amber_xin/Documents/自学/udemy/100 _codes_py/Day31_FlashCardProject/data/words_to_learn.csv",
                index=False)
    next_card()
...
cross_image = PhotoImage(
    file="/Users/amber_xin/Documents/自学/udemy/100 _codes_py/Day31_FlashCardProject/images/wrong.png")
unknown_button = Button(image=cross_image, highlightthickness=0, command=next_card)
unknown_button.grid(row=1, column=0)

check_image = PhotoImage(
    file="/Users/amber_xin/Documents/自学/udemy/100 _codes_py/Day31_FlashCardProject/images/right.png")
